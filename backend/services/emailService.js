...
// Helper to send email asynchronously (non‑blocking)
...
// --------------------------------------------------------------
// AUTO‑REPLY TO CLIENT (Branded, modern, trust‑building)
// --------------------------------------------------------------
...
<div style="font-family: 'Poppins', 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 20px 35px -10px rgba(0,0,0,0.1);">
  ...
  <div style="padding: 40px 30px;">
    ...
    <p style="color: #334155; line-height: 1.6;">One of our property specialists will contact you <strong style="color: #d69e2e;">within 24 hours</strong>. In the meantime, feel free to browse our resources or calculate your property’s ROI using our online tool.</p>
    ...
    <div style="text-align: center; margin-top: 20px;">
      <span style="display: inline-block; width: 32px; height: 32px; background: #1a365d; color: white; border-radius: 50%; line-height: 32px; text-align: center; font-size: 14px; margin: 0 4px;">f</span>
      <span style="display: inline-block; width: 32px; height: 32px; background: #1a365d; color: white; border-radius: 50%; line-height: 32px; text-align: center; font-size: 14px; margin: 0 4px;">in</span>
      <span style="display: inline-block; width: 32px; height: 32px; background: #1a365d; color: white; border-radius: 50%; line-height: 32px; text-align: center; font-size: 14px; margin: 0 4px;">ig</span>
    </div>
  </div>
</div>
  `;
  ...
  <div style="padding: 30px;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
      <tr style="background: #f8fafc;">
        <td style="padding: 12px; font-weight: 600; width: 35%;">Full Name</td>
        <td style="padding: 12px;">{{name}}</td>
      </tr>
      <tr>
        <td style="padding: 12px; font-weight: 600;">Email Address</td>
        <td style="padding: 12px;"><a href="mailto:{{email}}" style="color: #d69e2e; text-decoration: none;">{{email}}</a></td>
      </tr>
      <tr style="background: #f8fafc;">
        <td style="padding: 12px; font-weight: 600;">Phone Number</td>
        <td style="padding: 12px;">{{phone}}</td>
      </tr>
      <tr>
        <td style="padding: 12px; font-weight: 600;">Property Interest</td>
        <td style="padding: 12px;">{{propertyInterest}}</td>
      </tr>
      <tr style="background: #f8fafc;">
